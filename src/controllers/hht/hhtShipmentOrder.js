...
export const getShipmentOrderDetails = async (req, res) => {
  ...
  try {
    const result = await executeQuery(`EXEC [dbo].[fg_hht_shipment_order_details] @shipment_no, @item_code, @lot_no, @picked_status`, [
...
export const validateShipmentOrderBarcode = async (req, res) => {
  ...
  try {
    const result = await executeQuery(`EXEC [dbo].[fg_hht_shipment_order_validation] @serial_no, @shipment_no, @shipment_lot_no, @shipment_item_code`, [
...
export const updateShipmentOrderPicking = async (req, res) => {
  ...
  try {
    const result = await executeQuery(`EXEC [dbo].[fg_hht_shipment_order_update] @serial_no, @shipment_no, @shipment_item_code, @picked_by, @lot_no`, [
      { name: 'serial_no', type: sql.NVarChar(255), value: serial_no },
      { name: 'shipment_no', type: sql.NVarChar(50), value: shipment_no },
      { name: 'shipment_item_code', type: sql.NVarChar(50), value: shipment_item_code },
...
export const manualCloseShipmentOrder = async (req, res) => {
  ...
  try {
    const result = await executeQuery(`EXEC [dbo].[fg_hht_shipment_order_manual_close] @shipment_no, @item_code, @lot_no, @close_by`, [
      { name: 'shipment_no', type: sql.NVarChar(50), value: shipment_no },
      { name: 'item_code', type: sql.NVarChar(50), value: item_code },
      { name: 'lot_no', type: sql.NVarChar(50), value: lot_no },
...
export const getShipmentOrderRecentPickedDetails = async (req, res) => {
  ...
  try {
    const result = await executeQuery(`EXEC [dbo].[fg_hht_shipment_order_recent_picked_details] @shipment_no, @item_code, @lot_no`, [
      { name: 'shipment_no', type: sql.NVarChar(50), value: shipment_no },
      { name: 'item_code', type: sql.NVarChar(50), value: item_code },
      { name: 'lot_no', type: sql.NVarChar(50), value: lot_no },
    ]);
