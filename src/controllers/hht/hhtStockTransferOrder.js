...
export const getStockTransferOrderDetails = async (req, res) => {
    ...
    try {
        const result = await executeQuery(`EXEC [dbo].[hht_stock_transfer_order_details] @stock_transfer_number, @item_code, @line_no, @picked_status`, [
...
export const validateStockTransfer = async (req, res) => {
  ...
  try {
    const result = await executeQuery(`EXEC [dbo].[hht_stock_transfer_validation] @stock_transfer_number, @item_code, @line_no, @serial_no`, [
      { name: 'stock_transfer_number', type: sql.NVarChar(50), value: stock_transfer_number },
      { name: 'item_code', type: sql.NVarChar(50), value: item_code },
      { name: 'line_no', type: sql.NVarChar(10), value: line_no },
...
export const updateStockTransfer = async (req, res) => {
  ...
  try {
    const result = await executeQuery(`EXEC [dbo].[hht_stock_transfer_update] @stock_transfer_number, @item_code, @lot_no, @line_no, @serial_no, @picked_by`, [
      { name: 'stock_transfer_number', type: sql.NVarChar(50), value: stock_transfer_number },
      { name: 'item_code', type: sql.NVarChar(50), value: item_code },
...
export const reverseStockTransfer = async (req, res) => {
  ...
  try {
    const result = await executeQuery(`EXEC [dbo].[hht_stock_transfer_reversal] @stock_transfer_number, @item_code, @line_no, @serial_no, @reverse_by`, [
      { name: 'stock_transfer_number', type: sql.NVarChar(50), value: stock_transfer_number },
      { name: 'item_code', type: sql.NVarChar(50), value: item_code },
      { name: 'line_no', type: sql.NVarChar(10), value: line_no },
      { name: 'serial_no', type: sql.NVarChar(255), value: serial_no },
...
export const manualCloseStockTransferOrder = async (req, res) => {
  ...
  try {
    const result = await executeQuery(`EXEC [dbo].[hht_stock_transfer_order_manual_close] @stock_transfer_no, @item_code, @line_no, @closed_by`, [
...
export const getRecentPickedDetails = async (req, res) => {
  ...
  try {
    const result = await executeQuery(`EXEC [dbo].[hht_stock_transfer_order_recent_picked_details] @stock_transfer_number, @line_no, @item_code`, [
      { name: 'stock_transfer_number', type: sql.NVarChar(50), value: stock_transfer_number },
      { name: 'line_no', type: sql.NVarChar(10), value: line_no },
      { name: 'item_code', type: sql.NVarChar(50), value: item_code },
    ]);
