...
export const getWarehouseScrapping = async (req, res) => {
  const { FromDate, ToDate, OrderNo, Material, MaterialText, Batch } = req.body;
  try {
    const result = await executeQuery(
      'EXEC Sp_Rep_WarehouseScrapping @FromDate, @ToDate, @OrderNo, @Material, @MaterialText, @Batch',
      [
